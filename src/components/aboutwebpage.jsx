    ...
    return (
        <div className="admin-dashboard-wrapper" dir="ltr">
            ...
            <div className="admin-tabs-list">
                ...
                <Link to="/admin/dashboard/contact"><button className={`admin-tab-item ${isActive('/admin/dashboard/contact') ? 'is-active' : ''}`}>Contact</button></Link>
                <Link to="/admin/dashboard/gallery"><button className={`admin-tab-item ${isActive('/admin/dashboard/gallery') ? 'is-active' : ''}`}>Gallery</button></Link>
